    ...
    <h1 class="card-title text-center mb-5 text-success">Summery</h1>
        <div class="row ">
            ...
            <div class="col-sm-12 col-lg-6 card bg-success" style="height:40vh; width:25rem;">
                ...
                <div class="text-center mt-3"><h1>Total Students</h1></div>
            </div>
            <div class="col-sm-12">
                <table class="table table-striped table-bordered table-hover black mt-3">
                    <h3 class="table-title text-center text-capitalize mb-4 black mt-4">Gender details with Respect to courses</h3>
                    <thead>
                        <tr class=" black">
                            <th>S.N</th>
                            <th>Courses</th>
